...
public class Constants {
    ...
    public static final String NAIVE_BAYES_TEST_FILENAME = "nb/naive_bayes.test.inputs";
    public static final String NAIVE_BAYES_UNIGRAM_TRAIN = "nb/naive_bayes_train.py";
    public static final String NAIVE_BAYES_UNIGRAM_TEST = "nb/naive_bayes_test.py";
    public static final String NAIVE_BAYES_PREDICTION_FILENAME = "nb/naive_bayes.test.predictions";

    public static final String WEKA_TRAIN_FILENAME = "weka/train.inputs";
    public static final String WEKA_TEST_FILENAME = "weka/test.inputs";
